...
mod.fix <- plm(target_quant_per_swab ~ svl_mm, index = c("site"), model = "random", data=final_data)

mod <- plm(target_quant_per_swab ~ svl_mm, index = c("site"), model = "within", data=final_data)
