...
m11c_zln <- add_criterion(m11c_zln, "loo")

saveRDS(m11c_zln, file = "unified_models/unified_model_results_zln_life_tax_pt2_rgrtaxacorpt2poplsyrkg3tax_p10t30.rds")
m11c_zln = readRDS(file = "unified_models/unified_model_results_zln_life_tax_pt2_rgrtaxacorpt2poplsyrkg3tax_p10t30.rds")
...
```{r}
as_draws_df(m11b_zln) |>
  select(
    sd_mean  = contains("sd_taxon_capture:population:life_stage_simple"),
    sd_sigma = contains("sd_taxon_capture:population__sigma")
  ) |>
  cor() |>
  round(2)
