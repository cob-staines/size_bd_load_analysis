...
results_chirps = gee_point.extract_timeseries(
    sites="environmental_timeseries_pull/inputs/site_date_all_2026-09-11.csv",
    products=["chirps"],
    combined=True,
...
results_chirts_pre_2017 = gee_point.extract_timeseries(
    sites="environmental_timeseries_pull/inputs/site_date_pre_2017_2026-09-11.csv",
...
result_chirts_post_2017 = chirts_era5_extract.extract_timeseries(
    sites="environmental_timeseries_pull/inputs/site_date_post_2017_2026-09-11.csv",
    product="tmax",
...
# combine outputs
results_chirps = pd.read_csv("environmental_timeseries_pull/outputs/all_sites_combined_20260911T1309.csv",
                             parse_dates=["date"],
                             dtype={"site_name": str}).rename(columns={"chirps": "precip_mm"})
results_chirts_pre_2017 = pd.read_csv("environmental_timeseries_pull/outputs/all_sites_combined_20260911T1326.csv",
                             parse_dates=["date"],
                             dtype={"site_name": str}).rename(columns={"chirts_tmax": "tmax_c"})
results_chirts_post_2017 = pd.read_csv("environmental_timeseries_pull/outputs/all_sites_combined_20260911T1332.csv",
                             parse_dates=["date"],
...
results_all.to_csv("environmental_timeseries_pull/outputs/all_sites_combined_chirps_chirts_2026-09-11.csv", index = False)