...
# setup
librarian::shelf(tidyverse, dbplyr, here, janitor, RPostgres, DBI, RIBBiTR-BII/ribbitrrr, brms, tidybayes, ggplot2, runner, cmdstanr)
...
m3_zln <- brm(
  formula = bf(
    bd_load_co_density ~ 1 + life_stage_simple * taxon_capture + (1 + life_stage_simple | population),
    hu ~ 1 + life_stage_simple * taxon_capture + (1 + life_stage_simple | population),
    sigma ~ 1 + taxon_capture
  ),
  data = brms_data,
  family = hurdle_lognormal(),
...
saveRDS(m3_zln, file = here("unified_models/unified_model_results_zln_life_tax_popb.rds"))
m3_zln = readRDS(file = here("unified_models/unified_model_results_zln_life_tax_popb.rds"))


m4_zln <- brm(
  formula = bf(
    bd_load_co_density ~ 1 + life_stage_simple * taxon_capture + precip_mm_30_z + temp_c_30_z + (1 + life_stage_simple | population),
    hu ~ 1 + life_stage_simple * taxon_capture + precip_mm_15_z + temp_c_15_z + (1 + life_stage_simple | population),
    sigma ~ 1 + taxon_capture
  ),
  data = brms_data,
  family = hurdle_lognormal(),
...
m5_zln <- brm(
  formula = bf(
    bd_load_co_density ~ 1 + life_stage_simple * taxon_capture + precip_mm_30_z + precip_mm_30_z2 + temp_c_30_z + temp_c_30_z2 + (1 + life_stage_simple | population),
    hu ~ 1 + life_stage_simple * taxon_capture + precip_mm_15_z + precip_mm_15_z2 + temp_c_15_z + temp_c_15_z2 + (1 + life_stage_simple | population),
    sigma ~ 1 + taxon_capture
  ),
  data = brms_data,
  family = hurdle_lognormal(),
...
saveRDS(m5_zln, file = "unified_models/unified_model_results_zln_life_tax_pop_env2.rds")
m5_zln = readRDS(file = "unified_models/unified_model_results_zln_life_tax_pop_env2.rds")

m6_zln <- brm(
  formula = bf(
    bd_load_co_density ~ 1 + life_stage_simple * taxon_capture + precip_mm_30_z + precip_mm_30_z2 + temp_c_30_z + temp_c_30_z2 + site_precip_mm_annual_mean_z + site_temp_c_mean_z + (1 + life_stage_simple | population),
    hu ~ 1 + life_stage_simple * taxon_capture + precip_mm_15_z + precip_mm_15_z2 + temp_c_15_z + temp_c_15_z2 + site_precip_mm_annual_mean_z + site_temp_c_mean_z + (1 + life_stage_simple | population),
    sigma ~ 1 + taxon_capture
  ),
  data = brms_data,
  family = hurdle_lognormal(),
...
saveRDS(m6_zln, file = "unified_models/unified_model_results_zln_life_tax_pop_cli_env2.rds")
m6_zln = readRDS(file = "unified_models/unified_model_results_zln_life_tax_pop_cli_env2.rds")
...
VarCorr(m2_zln)$population$sd[1, "Estimate"]
fixef(m2_zln)["life_stage_simplesubadult", "Est.Error"] * .5
