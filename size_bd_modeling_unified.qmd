...
# sites_dates = bd_model %>%
#   group_by(site) %>%
#   summarize(date_1 = min(date),
#             date_2 = max(date),
#             .groups = "drop") %>%
#   mutate(date_1 = date_1 - days(temporal_buffer),
#          max_years = year_chunk)
# 
# sites_dates_chunks = sites_dates %>%
#   rowwise() %>%
#   mutate(chunks = list(chunk_date_range(date_1, date_2, max_years))) %>%
#   unnest(chunks) %>%
...
# write_csv(sites_dates_chunks, here("python", "gee_env_pull", "data", paste0("site_coords_dates_", today(), ".csv")))
# write_csv(head(sites_dates_chunks, n = 5), here("python", "gee_env_pull", "data", paste0("site_coords_dates_", today(), "_test.csv")))
