...
ggplot(hu_taxon_subadult, aes(x = hu_subadult)) +
  ...
  xlim(-5, 5) +
  theme_minimal() +
  labs(title = "Logit Prevalence (hu) Parameter Values",
       x = "Logit Prevalence (hu)",
       y = "Density")
...
ggplot(b_taxon_subadult, aes(x = b_subadult)) +
  ...
  theme_minimal() +
  xlim(-4, 6) + 
  labs(title = "Log Load (b) Parameter Values",
       x = "Log Load (b)",
       y = "Density")
...
ggplot(taxon_subadult_rope, aes(x = hu_median, y = b_median, color = species)) +
  ...
  geom_text_repel(aes(label = species)) +
  theme_minimal() +
  labs(title = "Median Parameter Values",
       x = "Median prevalence (hu)",
       y = "Median load (b)")
