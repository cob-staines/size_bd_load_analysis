...
b_taxon_subadult_rope = b_taxon_subadult %>%
  ...
  mutate(
    hdi_rope_89 = case_when(
      hdi_89$CI_low > 0.1 * median_b_sigma | hdi_89$CI_high <= -0.1 * median_b_sigma ~ TRUE,
      hdi_89$CI_low > -0.1 * median_b_sigma & hdi_89$CI_high <= 0.1 * median_b_sigma ~ FALSE,
      .default = NA
    ),
    hdi_rope_95 = case_when(
      hdi_95$CI_low > 0.1 * median_b_sigma | hdi_95$CI_high <= -0.1 * median_b_sigma ~ TRUE,
      hdi_95$CI_low > -0.1 * median_b_sigma & hdi_95$CI_high <= 0.1 * median_b_sigma ~ FALSE,
      .default = NA
    ))
