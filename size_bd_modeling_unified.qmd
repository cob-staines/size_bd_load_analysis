...
usgs_clean = usgs_raw %>%
  ...
  mutate(taxon_capture = paste0(tolower(gsub(" ", "_", scientific_name)), "_usgs"),
         taxon_capture = recode_values(taxon_capture,
                                       "lithobates_catesbeianus_usgs" ~ "rana_catesbeiana_usgs",
                                       default = taxon_capture),
...
env_in = read_csv(here("python", "environmental_timeseries_pull", "outputs", "all_sites_combined_chirps_chirts_2026-03-08.csv")) %>%
  rename(site = site_name,
