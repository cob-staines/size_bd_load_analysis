...
## modeled log load
(plot_4 = plot_load_mod(pps_atva, spec_name))
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_copa, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
draws_crcr = collect_draws(m_zln_crcr) %>%
  mutate(taxon_capture = spec_name)
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_crcr, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
draws_crfi = collect_draws(m_zln_crfi) %>%
  mutate(taxon_capture = spec_name)
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_crfi, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
draws_espr = collect_draws(m_zln_espr) %>%
  mutate(taxon_capture = spec_name)
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_espr, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_liwa, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_rhha, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_saal, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_sifl, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
draws_smsi = collect_draws(m_zln_smsi) %>%
  mutate(taxon_capture = spec_name)
...
#| echo: false
#| warning: false
(plot_4 = plot_load_mod(pps_smsi, spec_name))
```
### Modeled Bd load PDF
```{r}
#| echo: false
...
# Next steps:
  ...
  - Should distributions be done with b_eff of b_sigma? Currently with b_eff
  - Rerun model on bd_load (not bd_load_int)
  - When box-plotting bd-load, b_eff (or b_sigma?) needs to feature (currently only shows distribution of b)
