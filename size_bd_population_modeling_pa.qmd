...
collect_draws = function(m_spec){
  m_spec %>%
    ...
    mutate(p0 = plogis(b_hu),
           prevalence = 1 - p0,
           sd_eff = sqrt(b_sigma^2 + sd_population__Intercept^2))
}
...
#| warning: false
#| code-fold: true
#| code-summary: "Show Albomac code"
...
#| warning: false
#| code-fold: true
#| code-summary: "Show Flotator code"
