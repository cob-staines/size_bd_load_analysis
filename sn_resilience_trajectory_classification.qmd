...
ggplot(pop_year_bd, aes(x = year)) +
  geom_point(aes(y = log(adult_count_visual), color = "VES")) +
  geom_line(aes(y = log(adult_count_visual), color = "VES")) +
  geom_point(aes(y = log(adult_count_cmr), color = "CMR")) +
  geom_line(aes(y = log(adult_count_cmr), color = "CMR")) +
  geom_point(aes(y = adult_bd_prevalence * 15, color = "Bd Prev")) +
  geom_line(aes(y = adult_bd_prevalence * 15, color = "Bd Prev")) +
  geom_point(aes(y = log(adult_positive_bd_load_median), color = "Bd Load")) +
  geom_line(aes(y = log(adult_positive_bd_load_median), color = "Bd Load")) +
