...
ggplot(pop_year_class, aes(x = year)) +
  geom_point(aes(y = log10(adult_count + 1), color = "log10(Count + 1)"), size = psize) +
  geom_line(aes(y = log10(adult_count_terp + 1), color = "log10(Count + 1)")) +
  geom_point(aes(y = adult_bd_prevalence * 10, color = "Bd Prev (x10)"), size = psize) +
  geom_line(aes(y = adult_bd_prevalence_terp * 10, color = "Bd Prev (x10)")) +
  ...
  geom_point(aes(y = log10(adult_bd_load_max + 1), color = "log10(Bd Load max)"), size = psize) +
  geom_line(aes(y = log10(adult_bd_load_max_terp + 1), color = "log10(Bd Load max)")) +
  geom_point(aes(y = log10(adult_positive_bd_load_geom_mean + 1), color = "log10(Bd Load all + 1)"), size = psize) +
  geom_line(aes(y = log10(adult_positive_bd_load_geom_mean_terp + 1), color = "log10(Bd Load all + 1)")) +
  ...
  geom_hline(yintercept = log10(20), linetype = "dashed", color = "#ffb00d") +
  ...
  geom_vline(data = treatment_events_valid %>%
               filter(grepl("antifungal", treatment_type)), aes(xintercept = year), color = "red", linetype = "dashed") +
  facet_wrap(population ~ .) +
  scale_color_manual(values = c("log10(Count + 1)" = "#ffb00d",
                                "Bd Prev (x10)" = "#dd217d",
                                # "log10(Bd Load + 1)" = "#5b8efd",
                                # "log10(Bd Load_mean + 1)" = "#8e5bfd",
                                "log10(Bd Load max)" = "#000",
                                "log10(Bd Load all + 1)" = "#f00")) +
